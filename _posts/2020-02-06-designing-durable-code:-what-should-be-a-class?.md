...
&emsp;<figcaption class="center">&emsp;&emsp;&emsp;&emsp;Screenshot of program running in console</figcaption>
 </figure>
...
<p>&emsp;As you can see, I have created classes to represent each of the nouns in the description, except for <b>mines</b> and <b>numbers</b>.</p>
<p>&emsp;This is due to Metz's second rule: a noun that has both <em>data</em> and <em>behavior</em> associated with it deserves to be a class.</p>
